...
const STAT_INFO = {
  projects: {
    ...
    text: 'Eritrea has 2 climate-related projects in partnership with the Green Climate Fund and other international organizations. These projects span across adaptation, mitigation, and capacity building sectors, contributing to the country\'s sustainable development goals.'
  },
  funding: {
    title: 'Total GCF Financing',
    text: '$21.1 million has been mobilized for climate action in Eritrea through the Green Climate Fund. This funding supports institutional strengthening, project development, and climate resilience initiatives.'
  },
  activities: {
    title: 'No. of Readiness Activities',
    text: 'Eritrea has implemented 3 readiness activities focused on strengthening institutional capacity, developing project pipelines, and enhancing coordination for effective climate finance engagement.'
  },
  readiness: {
    title: 'Readiness Support Approved',
    text: '$3.5 million in readiness support has been approved for Eritrea to build national capacity, develop robust governance frameworks, and enhance stakeholder engagement for climate action.'
  }
};
